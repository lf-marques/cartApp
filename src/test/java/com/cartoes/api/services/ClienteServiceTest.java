...
public class ClienteServiceTest {
	...
	public void testBuscarPorCpfExistente() throws ConsistenciaException {
		...
		BDDMockito.given(clienteRepository.findByCpf(Mockito.anyString())).willReturn(new Cliente());
	...
	public void testBuscarPorCpfNaoExistente() throws ConsistenciaException {
		...
		BDDMockito.given(clienteRepository.findByCpf(Mockito.anyString())).willReturn(null);
